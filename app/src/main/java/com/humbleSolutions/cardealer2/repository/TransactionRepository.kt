...
import com.humbleSolutions.cardealer2.data.TransactionStatus
...
object TransactionRepository {
    ...
    suspend fun transferBetweenSources(
        ...
        fromCustomer: com.humbleSolutions.cardealer2.data.Customer?,  // Full Customer object if fromType == "Customer"
        fromBroker: com.humbleSolutions.cardealer2.data.Broker?,      // Full Broker object if fromType == "Broker"
        toType: String,    // "Customer", "Broker", "Cash", "Bank"
        toCustomer: com.humbleSolutions.cardealer2.data.Customer?,    // Full Customer object if toType == "Customer"
        toBroker: com.humbleSolutions.cardealer2.data.Broker?,        // Full Broker object if toType == "Broker"
        amount: Double,
